...
def ppo_step(policy_net, value_net, optimizer_policy, optimizer_value, optim_value_iternum, states, actions,
    ...
    #action_mean, action_log_std, action_std = policy_net.forward(Variable(states))
    #log_probs = normal_log_density(Variable(actions), action_mean, action_log_std, action_std)
