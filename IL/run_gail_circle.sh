...
args=(
  ...
  --results_dir ./results/circle/gail/meta_1_traj_100_opposite_circles_equal_radii/action_policy_output_normalized/context_2_goal_1_history_1/disc_with_nextc_posterior_0.01_lr_1e-4_with_policy_l2_0.1/opposite_dir

   --checkpoint_path ./results/circle/gail/meta_1_traj_100_opposite_circles_equal_radii/action_policy_output_normalized/context_2_goal_1_history_1/disc_with_nextc_posterior_0.01_lr_1e-4_with_policy_l2_0.1/checkpoint/cp_600.pth
